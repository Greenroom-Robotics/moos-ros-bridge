...
void MOOSNode::AssignPublisher(vector<IMsgContainer> *new_msgVec){
     msgVec = new_msgVec;
}
...
bool MOOSNode::OnNewMail (MOOSMSG_LIST &NewMail){
     ...
     for( p = NewMail.begin() ; p != NewMail.end() ; p++ ){
	  ...
	  vector<IMsgContainer>::iterator it;
